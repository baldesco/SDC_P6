...
/**
 * Calculates the Multivariate-Gaussian probability density for a single measurement.
 * Function provided by Udacity at the "Implementation of a particle filter" module.
 */

inline double multi_prob(double sig_x, double sig_y, double x_obs, double y_obs,
